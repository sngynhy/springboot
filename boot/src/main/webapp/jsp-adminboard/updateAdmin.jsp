					...
					<div id="main">
						<div class="inner">
							...
							<section style="padding-top: 35px;">
								...
								<!-- 게시글 입력 폼 -->								
								<form method="post" action="/updateAdminBoard.do" name="form1" enctype="multipart/form-data">
									...
									<div class="image-container" style="float: left;">
									    <img style="width: 100px;" id="preview-image" src="${data.img_path}">
									</div>
